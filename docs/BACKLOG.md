...
- **Pendiente futuro (no hecho):** "automática" más lista que el default por categoría — proponer la cadencia desde el ritmo real de contacto (mediana de gaps entre interacciones), no sólo la categoría.
