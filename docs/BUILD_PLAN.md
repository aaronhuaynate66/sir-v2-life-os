...
- `18_EXTERNAL_SIGNALS` — señales externas (el afuera cruzado con tu contexto: dólar/clima/eventos). Tesis: externo × interno = señal, externo solo = ruido. La infra (FX+GDELT) ya existía pero solo en objetivos-viaje. **18·M1 (dólar generalizado a /finanzas) HECHO.**
