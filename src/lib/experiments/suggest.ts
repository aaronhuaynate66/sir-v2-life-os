...
// concreto, derivado de la brecha más severa. Activación conductual: una sola
// acción, medible, atada a su material real. Determinístico, sin IA.

import type { EspejoSemanal, EspejoSeverity } from '@/lib/self/espejoSemanal'
