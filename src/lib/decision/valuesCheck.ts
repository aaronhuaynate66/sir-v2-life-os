...
// valores, SIR trae tus ANCLAS (el ancla del año + quién eres) para que revises la
...
export interface CoherenceSources {
  ...
  /** Bio / "quién eres" del perfil de identidad. */
  identityBio?: string
}
 ...
 *  (la más concreta y específica) primero, luego quién eres. */
