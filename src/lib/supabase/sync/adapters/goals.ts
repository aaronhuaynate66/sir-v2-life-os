...
export const goalAdapter: TableAdapter<Goal> = {
  ...
  toRow: (g, userId) => ({
    ...
    why: g.why ?? null,
    is_anchor: g.isAnchor ?? false,
    anchor_subtitle: g.anchorSubtitle ?? null,
  ...
  fromRow: (row) => ({
    ...
    isAnchor: (row.is_anchor as boolean) ?? false,
    anchorSubtitle: (row.anchor_subtitle as string) ?? undefined,
