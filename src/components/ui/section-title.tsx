...
export function SectionTitle({ icon: Icon, label, count }: SectionTitleProps) {
  return (
    <div className="flex items-center gap-2 mb-4">
      ...
      {/* Heading semántico (a11y U2): navegable por lector de pantalla, mismo look. */}
      <h2 className="text-[11px] uppercase tracking-[0.07em] text-text-tertiary font-sans">{label}</h2>
      {count !== undefined && (
