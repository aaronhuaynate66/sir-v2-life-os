'use client'
// SIR V2 — Subir/elegir imagen del panel de FC. File picker + drag&drop.
...
interface HeartRateCaptureUploaderProps {
  onFile: (file: File) => void
  disabled?: boolean
}

export function HeartRateCaptureUploader({ onFile, disabled }: HeartRateCaptureUploaderProps) {
    ...
    <Card className="shadow-none">
      <CardContent className="p-4 sm:p-6">
        <div
          ...
          aria-label="Seleccionar imagen del panel de frecuencia cardíaca"
          onKeyDown={(e) => {
