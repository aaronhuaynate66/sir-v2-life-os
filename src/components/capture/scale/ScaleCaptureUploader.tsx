'use client'
// SIR V2 — Step 1: subir/elegir imagen de báscula.
// File picker + drag&drop nativo. Acepta image/*. Sin deps.
...
interface ScaleCaptureUploaderProps {
  onFile: (file: File) => void
  disabled?: boolean
}

export function ScaleCaptureUploader({ onFile, disabled }: ScaleCaptureUploaderProps) {
  ...
  async function handleFile(file: File) {
    setError(null)
    // PDF: convertimos la 1ra página a PNG (báscula suele ser 1 foto). Aviso si hay más.
    ...
    <Card className="shadow-none">
      <CardContent className="p-4 sm:p-6">
        <div
          ...
          aria-label="Seleccionar imagen de báscula"
          onKeyDown={(e) => {
