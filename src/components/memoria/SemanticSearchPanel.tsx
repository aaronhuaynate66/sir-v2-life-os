'use client'
// SIR V2 — SemanticSearchPanel: búsqueda semántica de memorias (antes /buscar).
//
// Vive embebido en /memoria bajo el toggle "Buscar con IA". Pregunta en lenguaje
// natural → embeddea la query y matchea contra memories.embedding vía /api/search.
