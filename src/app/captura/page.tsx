...
function CapturaIndexContent() {
  ...
  return (
    <AppShell>
      ...
      {/* Camino simple del Reader: pegar un hilo (Teams/Slack) sin extensión. */}
      <Link href="/captura/pegar" className="mb-4 flex items-center gap-2 rounded-lg border border-border bg-card px-4 py-3 text-sm hover:border-border-strong transition-colors">
