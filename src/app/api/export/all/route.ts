...
const TABLES: TableSpec[] = [
  ...
  { filename: 'tracker_points.csv', table: 'tracker_points', select: 'id, tracker_id, value, date, source, note, created_at', description: 'Mediciones de trackers.' },
  { filename: 'finance_movements.csv', table: 'finance_movements', select: 'id, type, amount_pen, description, category, intent, date, created_at', description: 'Ingresos/gastos.' },
