...
PHASES_META: list[dict[str, Any]] = [
    ...
    {
        "key": "fase-3a",
        "milestone_title": "Fase 3a - Historial Profundo",
        "title": "Fase 3a - Historial Profundo",
    ...
    {
        "key": "fase-3b",
        "milestone_title": "Fase 3b - Búsqueda Semántica",
        "title": "Fase 3b - Búsqueda Semántica",
    ...
    {
        "key": "fase-3c",
        "milestone_title": "Fase 3c - Resumen Patrones Longitudinales",
        "title": "Fase 3c - Resumen Patrones Longitudinales",
        "period": "Insights automaticos",
        "wedge": "LLM analiza historial y genera insights longitudinales automaticos",
        "gate": "SIR genera 1 resumen semanal accionable con patrones observados",
        "active": False,
    },
    {
        "key": "fase-3d",
        "milestone_title": "Fase 3d - Memoria Que Aprende",
        "title": "Fase 3d - Memoria Que Aprende",
        "period": "RAG cross-session",
        "wedge": "Arquitectura de memoria persistente (short/medium/long term) con RAG",
        "gate": "Cada interaccion con SIR tiene contexto profundo automatico del usuario",
        "active": False,
    },
    {
        "key": "fase-5",
...
CATEGORY_RULES: list[tuple[str, set[str], list[str]]] = [
    ...
    ("Memory Longitudinal (3a/b/c/d)", {"fase-3", "fase-3a", "fase-3b", "fase-3c", "fase-3d"}, ["memory", "semantic", "longitudinal", "timeline", "historial", "rag", "embedding", "pgvector"]),
